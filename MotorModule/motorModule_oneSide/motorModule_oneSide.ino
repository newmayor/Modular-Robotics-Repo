...
int y;
int state;
int testSteps = 2083; //degrees of rotor rotation
...
void StepForwardDefault()
{
  ...
  for(x= 1; x<testSteps; x++)  //Loop the forward stepping enough times for motion to be visible
  {
